...
2.  **Переменные окружения:**
    ...
    *   `WEBHOOK_URL`: Полный URL для вебхука (по умолчанию: `/webhook`).
...
Для работы системы модерации требуется запущенный сервис Ollama с моделями `aya-expanse:8b` и `llava:7b`.
...
3.  **Настройте переменные окружения**:
    ...
    Также укажите `MODERATION_CHANNEL_ID` — ID чата, куда будут приходить уведомления о подозрительных триггерах.
