    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-bg text-text">
      ...
      {oidcEnabled ? (
        <a
          ...
          className="flex items-center justify-center gap-2.5 px-6 py-3 rounded-xl bg-[#2AABEE] text-white visited:text-white no-underline text-sm font-semibold hover:opacity-90 transition-opacity"
        >
