...
captcha-not-found = ❌ Сессия капчи не найдена или истекла.
...
captcha-emoji = 👋 { $user }, выберите { $emoji }, чтобы подтвердить, что вы не робот.
captcha-not-for-you = ❌ Эта кнопка не для вас!
...
var-not-found = ❌ Переменная <code>{ $name }</code> не найдена.
