...
# AI Moderation (llama-server OpenAI API)
INFERENCE_URL="${INFERENCE_URL:-http://10.10.40.24:8090}"
INFERENCE_TIMEOUT="${INFERENCE_TIMEOUT:-600}"
INFERENCE_STALE_ALERT_TIMEOUT="${INFERENCE_STALE_ALERT_TIMEOUT:-300}"

# ASR (faster-whisper, транскрипция voice/video_note)
ASR_URL="${ASR_URL:-http://10.10.40.24:8091}"
ASR_TOKEN="${ASR_TOKEN:-}"
ASR_TIMEOUT="${ASR_TIMEOUT:-120}"
